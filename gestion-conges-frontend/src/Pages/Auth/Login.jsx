...
import { Mail, Lock, Loader2, CheckCircle2, AlertCircle, XCircle } from "lucide-react"; 
...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const serverMessage = err.response?.data?.message || "Erreur de connexion au serveur";
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-3">
                        <div className="input-group-custom">
                            ...
                            ? "is-invalid" 
                            : email 
                                ? (isEmailValid ? "is-valid" : "is-warning") 
                                : ""
                        }`}
                                placeholder="Email"
                                value={email}
